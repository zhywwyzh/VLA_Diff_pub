...
struct MINCOTraj_
{
  ...
  _start_time_type start_time;
   ...
   typedef float _des_clearance_type;
  _des_clearance_type des_clearance;
  ...
  _end_a_type end_a;
   ...
   typedef std::vector<float, typename ContainerAllocator::template rebind<float>::other >  _inner_x_type;
  _inner_x_type inner_x;

   typedef std::vector<float, typename ContainerAllocator::template rebind<float>::other >  _inner_y_type;
  _inner_y_type inner_y;

   typedef std::vector<float, typename ContainerAllocator::template rebind<float>::other >  _inner_z_type;
...
bool operator==(const ::traj_utils::MINCOTraj_<ContainerAllocator1> & lhs, const ::traj_utils::MINCOTraj_<ContainerAllocator2> & rhs)
{
  return lhs.drone_id == rhs.drone_id &&
    ...
    lhs.des_clearance == rhs.des_clearance &&
    lhs.order == rhs.order &&
...
struct MD5Sum< ::traj_utils::MINCOTraj_<ContainerAllocator> >
{
  ...
  {
    return "2d500a176e23c9d96e066cfe67365096";
  }

  static const char* value(const ::traj_utils::MINCOTraj_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x2d500a176e23c9d9ULL;
  static const uint64_t static_value2 = 0x6e066cfe67365096ULL;
};
...
struct Printer< ::traj_utils::MINCOTraj_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::traj_utils::MINCOTraj_<ContainerAllocator>& v)
  {
    ...
    s << indent << "des_clearance: ";
    Printer<float>::stream(s, indent + "  ", v.des_clearance);
    s << indent << "order: ";
