...
(cl:defclass <Px4ctrlDebug> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (fsm_state
    ...
    :initform 0.0)
   (last_fsm_state
    :reader last_fsm_state
    :initarg :last_fsm_state
    :type cl:float
    :initform 0.0)
   (err_axisang_x
...
(cl:defmethod fsm_state-val ((m <Px4ctrlDebug>))
...
(cl:ensure-generic-function 'last_fsm_state-val :lambda-list '(m))
(cl:defmethod last_fsm_state-val ((m <Px4ctrlDebug>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader quadrotor_msgs-msg:last_fsm_state-val is deprecated.  Use quadrotor_msgs-msg:last_fsm_state instead.")
  (last_fsm_state m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Px4ctrlDebug>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'voltage))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 48) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 56) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'fsm_state))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream)
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 48) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 56) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'last_fsm_state))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Px4ctrlDebug>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'header) istream)
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 48) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 56) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'fsm_state) (roslisp-utils:decode-double-float-bits bits)))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
      ...
      (cl:setf (cl:ldb (cl:byte 8 48) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 56) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'last_fsm_state) (roslisp-utils:decode-double-float-bits bits)))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Px4ctrlDebug>)))
  ...
  "b5e0abdbab8fec0ff23bfda24440378d")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Px4ctrlDebug)))
  "Returns md5sum for a message object of type 'Px4ctrlDebug"
  "b5e0abdbab8fec0ff23bfda24440378d")
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <Px4ctrlDebug>))
  ...
  (cl:list 'Px4ctrlDebug
    ...
    (cl:cons ':last_fsm_state (last_fsm_state msg))
