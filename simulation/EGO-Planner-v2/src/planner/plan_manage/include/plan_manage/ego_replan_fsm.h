...
namespace ego_planner
{
  ...
  private:
    // ADD
    ros::Subscriber emergency_flag_sub_;  // 紧急标志订阅者
    void emergencyFlagCallback(const std_msgs::Bool::ConstPtr &msg);
    bool emergency_flag_ = false;         // 记录当前紧急状态
    ...
    std::vector<Eigen::Vector3d> historical_waypoints_;
    ...
    void uavActionCallback(const geometry_msgs::PoseStampedConstPtr &msg);
