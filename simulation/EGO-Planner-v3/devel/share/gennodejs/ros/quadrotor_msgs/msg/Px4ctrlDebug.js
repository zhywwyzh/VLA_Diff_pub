...
class Px4ctrlDebug {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('last_fsm_state')) {
        this.last_fsm_state = initObj.last_fsm_state
      }
      else {
        this.last_fsm_state = 0.0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.float64(obj.fsm_state, buffer, bufferOffset);
    // Serialize message field [last_fsm_state]
    bufferOffset = _serializer.float64(obj.last_fsm_state, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.fsm_state = _deserializer.float64(buffer, bufferOffset);
    // Deserialize message field [last_fsm_state]
    data.last_fsm_state = _deserializer.float64(buffer, bufferOffset);
  ...
  static md5sum() {
    ...
    return 'b5e0abdbab8fec0ff23bfda24440378d';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.fsm_state !== undefined) {
      ...
      resolved.fsm_state = 0.0
    }

    if (msg.last_fsm_state !== undefined) {
      resolved.last_fsm_state = msg.last_fsm_state;
    }
    else {
      resolved.last_fsm_state = 0.0
    }
