...
(cl:defclass <LinktrackNodeframe3> (roslisp-msg-protocol:ros-message)
  ((role
   ...
   (nodes
    :reader nodes
    :initarg :nodes
    :type (cl:vector quadrotor_msgs-msg:LinktrackNode2)
   :initform (cl:make-array 0 :element-type 'quadrotor_msgs-msg:LinktrackNode2 :initial-element (cl:make-instance 'quadrotor_msgs-msg:LinktrackNode2))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <LinktrackNodeframe3>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LinktrackNodeframe3)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name quadrotor_msgs-msg:<LinktrackNodeframe3> is deprecated: use quadrotor_msgs-msg:LinktrackNodeframe3 instead.")))

(cl:ensure-generic-function 'role-val :lambda-list '(m))
(cl:defmethod role-val ((m <LinktrackNodeframe3>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader quadrotor_msgs-msg:role-val is deprecated.  Use quadrotor_msgs-msg:role instead.")
  (role m))
...
(cl:defmethod local_time-val ((m <LinktrackNodeframe3>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader quadrotor_msgs-msg:local_time-val is deprecated.  Use quadrotor_msgs-msg:local_time instead.")
  (local_time m))

(cl:ensure-generic-function 'system_time-val :lambda-list '(m))
(cl:defmethod system_time-val ((m <LinktrackNodeframe3>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader quadrotor_msgs-msg:system_time-val is deprecated.  Use quadrotor_msgs-msg:system_time instead.")
  (system_time m))
...
(cl:defmethod nodes-val ((m <LinktrackNodeframe3>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader quadrotor_msgs-msg:nodes-val is deprecated.  Use quadrotor_msgs-msg:nodes instead.")
  (nodes m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <LinktrackNodeframe3>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'nodes)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'quadrotor_msgs-msg:LinktrackNode2))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<LinktrackNodeframe3>)))
  ...
  "quadrotor_msgs/LinktrackNodeframe3")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'LinktrackNodeframe3)))
  "Returns string type for a message object of type 'LinktrackNodeframe3"
  "quadrotor_msgs/LinktrackNodeframe3")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<LinktrackNodeframe3>)))
  ...
  (cl:format cl:nil "uint8 role~%uint8 id~%uint32 local_time~%uint32 system_time~%float32 voltage~%LinktrackNode2[] nodes~%~%================================================================================~%MSG: quadrotor_msgs/LinktrackNode2~%uint8 role~%uint8 id~%float32 dis~%float32 fp_rssi~%float32 rx_rssi~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'LinktrackNodeframe3)))
  "Returns full string definition for message of type 'LinktrackNodeframe3"
  (cl:format cl:nil "uint8 role~%uint8 id~%uint32 local_time~%uint32 system_time~%float32 voltage~%LinktrackNode2[] nodes~%~%================================================================================~%MSG: quadrotor_msgs/LinktrackNode2~%uint8 role~%uint8 id~%float32 dis~%float32 fp_rssi~%float32 rx_rssi~%~%~%"))
