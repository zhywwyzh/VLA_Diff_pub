...
def main():
    ...
    for filename in sorted(os.listdir(parquet_dir)):
        ...
        try:
            ...
            output_dir_for_images = f"/data/vla/Openpi/test/infer/infer_output/{case_name}"
            ...
            plot_output_dir = f"/data/vla/Openpi/test/infer/trajectory_plots/{case_name}"
            ...
            output_path = f"/data/vla/Openpi/test/infer/trajectory_video/{case_name}/{output_filename}"
