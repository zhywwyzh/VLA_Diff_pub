...
# 查找相关的Python进程
python_processes=$(ps aux | grep -E "(app\.py|external_receiver_example\.py)" | grep -v grep | awk '{print $2}')
...
# 显示日志文件信息
if [ -f "logs/main_service.log" ] || [ -f "logs/external_receiver.log" ]; then
